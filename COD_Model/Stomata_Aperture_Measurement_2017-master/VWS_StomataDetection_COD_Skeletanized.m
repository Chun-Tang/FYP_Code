...
% Select image folder
%----------------------
imdirTest = 'C:\Users\Chun\Desktop\Y4_Project\DetectionSoftware\COD\Stomata_Aperture_Measurement_2017-master\Input\';

%Image output Directory
%----------------------
outputDir = 'C:\Users\Chun\Desktop\Y4_Project\DetectionSoftware\COD\Stomata_Aperture_Measurement_2017-master\Output\';
...
outputFileName = 'apertureAreas.csv';
outputFullPath = fullfile(outputDir, outputFileName);

csvwrite(outputFullPath, AreaList);
toc